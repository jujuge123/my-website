...
const I18N = {
  zh: {
    ...
    'contact.wechat.desc': '扫码添加 · 专属顾问即时响应',
    'contact.wechat.copy': '复制微信号',
    'contact.whatsapp.desc': '国际客户首选 · 全球即时通讯',
    'contact.whatsapp.btn': '立即对话',
    'contact.line.desc': '日韩 · 东南亚客户专属',
    'contact.line.btn': '前往 LINE',
  ...
  en: {
    ...
    'contact.wechat.desc': 'Scan to add · Instant advisor response',
    'contact.wechat.copy': 'Copy WeChat ID',
    'contact.whatsapp.desc': 'Preferred by international clients',
    'contact.whatsapp.btn': 'Chat Now',
  ...
  ja: {
    ...
    'contact.wechat.desc': 'スキャンして追加 · 即時対応',
    'contact.wechat.copy': 'WeChat IDをコピー',
    'contact.whatsapp.desc': '海外クライアント向け',
    'contact.whatsapp.btn': '今すぐチャット',
    'contact.line.desc': '日韓・東南アジア専用',
    'contact.line.btn': 'LINEを開く',
